...
public class CommandLogic implements CommandExecutor {
  ...
  public boolean onCommand(
      @NotNull CommandSender sender, @NotNull Command command, @NotNull String str, String[] args) {
    // Player-only; we can just use proper command registration for commands needing to be executed
    // by non-players
